...
const Workshops = ({ workshopsData, lang }) => {
  ...
  } = workshopsData.nodes[0]

  const Cards = [
    {
      title: homePageWorkshopsFirstColTitle,
      img: homePageWorkshopsFirstColImage,
      content: homePageWorkshopsFirstColContent,
    },
    {
      title: homePageWorkshopsThirdColTitle,
      img: homePageWorkshopsThirdColImage,
      content: homePageWorkshopsThirdColContent,
    },
    {
      title: homePageWorkshopsSecondColTitle,
      img: homePageWorkshopsSecondColImage,
      content: homePageWorkshopsSecondColContent,
    },
  ]
  ...
  return (
    <Section>
      <SectionHeader
        title={homePageWorkshopsHeading}
        subTitle={homePageWorkshopsSubHeading}
      />
      <SectionInner>
